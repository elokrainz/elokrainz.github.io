...
英雄升级,
    ...
    &ensp;从1级升到2级,有$$\frac{1}{3}$$的可能成功;$$\frac{1}{3}$$的可能停留原级;$$\frac{1}{3}$$的可能下降到0级;

    &ensp;从2级升到3级,有$$\frac{1}{9}$$的可能成功;$$\frac{4}{9}$$的可能停留原级;$$\frac{4}{9}$$的可能下降到1级.

    &ensp;每次升级要花费一个宝石,不管成功还是停留还是降级.

    &ensp;求英雄从0级升到3级平均花费的宝石数目.
